...
//
// API "twitter-clone": Application Contexts
//
// Command:
// $ goagen
...
type voteTopicPayload struct {
	...
	Vote *string `form:"vote,omitempty" json:"vote,omitempty" yaml:"vote,omitempty" xml:"vote,omitempty"`
}
...
type VoteTopicPayload struct {
	...
	// upvote/downvote topic
	Vote string `form:"vote" json:"vote" yaml:"vote" xml:"vote"`
}
